...
import { ImageInfo, PersonalInfo, insuranceSteps, steps } from "../constants";
  ...
  return (
    <div className='p-[3%] h-full'>
      <div className='w-full min-h-full flex flex-col items-center'>
        <h1 className='text-3xl font-[600]'>Định danh bệnh nhân</h1>
        <Step
          step={0}
          steps={
            patientInfo.consultationSession?.isInsurance
              ? insuranceSteps
              : steps
          }
        />
        ...
        <div className='w-full'>
          <ButtonFooter
            next={patientInfo.personalInfo ? "/camera-identification" : ""}
            isNextLoading={!patientInfo.personalInfo}
            prev={"/form-medical-examination"}
          />
        </div>
      </div>
    </div>
